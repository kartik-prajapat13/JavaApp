...
<%-- This is CSS style code also we can write separately in CSS --%>>
...
Following images of sun and moon and rain generated from this one 

according to switch cases there is different conditions  are given
 --%>
